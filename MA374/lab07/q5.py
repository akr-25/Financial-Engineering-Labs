...
def SensitivityAnalysis(paramToChange, range):
    ...
    plt.savefig('image/q5/Sensitivity Analysis of ' + paramsName[paramToChange])
    plt.close()
    return callPrice, putPrice
...
def SensitivityAnalysis3D(paramToChange1, range1, paramToChange2, range2):
    ...
    plt.savefig('image/q5/Sensitivity Analysis of ' + paramToChange1 + ' and ' + paramToChange2 + '.png')
    plt.close()
    return callPrice, putPrice
